    ...
    <main class="main">
        ...
        <section class="events">
            <div class="event-card">
                ...
                <button>
                    <a href="event_details.php?event_id=1" style="text-decoration: none; color: inherit;">View Details</a>
                </button>
            </div>
            ...
            <div class="event-card">
                ...
                <button>
                    <a href="event_details.php?event_id=2" style="text-decoration: none; color: inherit;">View Details</a>
                </button>
            </div>
            ...
            <div class="event-card">
                ...
                <button>
                    <a href="event_details.php?event_id=3" style="text-decoration: none; color: inherit;">View Details</a>
                </button>
            </div>
